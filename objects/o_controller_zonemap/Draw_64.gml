...
if (location_prompt_text != "" && !instance_exists(par_interface) &&
    global.context == context.zone_map && !ai_turn) {
	...
	location_prompt_button.y = round(location_prompt_y + 2);
	...
	draw_text_ext(round(GUIW/2), round(location_prompt_y + sprite_get_height(s_button_large)*1.25 + string_height(location_prompt_name)*1.5),
